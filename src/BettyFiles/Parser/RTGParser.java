...
import BettyFiles.treedata.Node;
import BettyFiles.Symbol;
...
public class RTGParser{
    ...
    */
     ...
     * counter. */
    private Node buildTree(String rhs, int nOfChildren) throws SymbolUsageException {
    ...
    /* Checks if the line contains illegal characters, in this case
